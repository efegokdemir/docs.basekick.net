...
description: "How Arc partitions Parquet files by event timestamp rather than ingestion time, so backfilled history lands in the right partitions and time-range pruning works."
---
